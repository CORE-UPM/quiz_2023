...
// Route to get the answer of the given quiz.
router.get('/quizzes/:quizId_woi(\\d+)/answer',
    quizApi.answer);
...
// wa = with answers
//
// Comentado para que no se use en las practicas de IWEB del curso 2023/2024
//router.get('/quizzes/random10wa',
//    quizApi.random10wa);

// Route to get 10 random quizzes, no including answers.
// Returns 10 or less depending on the DDBB size.
router.get('/quizzes/random10',
    quizApi.random10);
